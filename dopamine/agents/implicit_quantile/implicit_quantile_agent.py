...
class ImplicitQuantileAgent(rainbow_agent.RainbowAgent):
  ...
  def _build_train_op(self):
    ...
    target_quantile_values = tf.transpose(target_quantile_values, [1, 0, 2]) #(b,n',1)
    ...
    chosen_action_quantile_values = tf.transpose(
        chosen_action_quantile_values, [1, 0, 2]) #(b,n,1)
    ...
    # TODO: Add prioritized replay functionality here.
